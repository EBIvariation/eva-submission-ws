...
public class AdminController extends BaseController {
    ...
    @PostMapping("submission/initiate/{identifier}")
    public ResponseEntity<?> initiateSubmission(@PathVariable("identifier") String identifier) {
        String submissionId = this.submissionService.initiateSubmissionByEVA(identifier);
        logger.info("Admin Initiate Submission generated submission Id {}", submissionId);
